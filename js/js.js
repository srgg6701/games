// preload images if is necessary
(function (){
    var img,iDir = 'images/';
    var imgs = ['yellowButton1.svg'];
    for(var i in imgs){
        img=new Image();
        img.src=iDir+imgs[i]; console.log('src = '+img.src);
    }
})();

var demo_login = 'demouser';
var demo_pass = '111111';
...
$(function() {
    ...
    setTimeout(function() {
        ...
        $(login).val(demo_login);
        $(password).val(demo_pass);
